...
public class Data {
    ...
    public final static ArrayList<TargetObject> targetObjects = new ArrayList<TargetObject>() {{
        ...
        add(new TargetObject(15, TargetType.BUILDING, 9.937967, -84.052035, 0, new int[]{37},       "Escuela de Computación e Informática", "ecci", "Fofidescripcion de la ECCI", "Videoplayback/ecci.mp4", "www.museodeinsectoscr.com"));
